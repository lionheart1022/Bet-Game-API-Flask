...
def upgrade():
    ...
    sa.Column('open', sa.Boolean(), server_default='0', nullable=False),
    ...
    op.drop_index('ix_game_aborter_id', table_name='game')
...
def downgrade():
    ...
    op.create_index('ix_game_aborter_id', 'game', ['aborter_id'], unique=False)
    ...
    op.add_column('beta', sa.Column('medium', mysql.VARCHAR(length=128), nullable=True))
    op.create_table('stream',
    sa.Column('id', mysql.INTEGER(display_width=11), nullable=False),
    sa.Column('handle', mysql.VARCHAR(length=64), nullable=False),
    sa.Column('gametype', mysql.VARCHAR(length=64), nullable=True),
    sa.Column('child', mysql.VARCHAR(length=64), nullable=True),
    sa.Column('game_id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('game_ids_supplementary', mysql.TEXT(), nullable=True),
    sa.Column('state', mysql.VARCHAR(length=8), nullable=True),
    sa.Column('creator', mysql.VARCHAR(length=128), nullable=True),
    sa.Column('opponent', mysql.VARCHAR(length=128), nullable=True),
    sa.PrimaryKeyConstraint('id'),
